# TODO - need to evaluate whether we keep minikube and if so make it functional
# TODO at current time minikube and minikube-none are not functional
# This assumes the istio binaries are pre-built and available in HUB
# with TAG.  The test code is clone from a specific release point. 
...
ISTIOCTL_BIN ?= ${ISTIO_SRC}/istioctl
...
e2e_simple: generate_yaml e2e_simple_run
